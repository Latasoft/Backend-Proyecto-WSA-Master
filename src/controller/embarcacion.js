...
export async function getEmbarcacionById(req,res){
    ...
    const userRole = req.user.role; // 'TRABAJADOR' o 'ADMIN'
    
    const response= await embarcacionService.getEmbarcacionById(_id,userRole)
...
export async function updateEmbarcacion(req,res){
    ...
    const response= await embarcacionService.actualizarEmbarcacion(_id,req.body,userRole)
